...
class ProficiencyTest {
    ...
    @Test
    fun everyMeleeArmBelongsToExactlyOneFamily() {
        // The bow is no one's melee craft; it swings like bare hands.
        assertNull(WeaponCategory.forWeapon(ItemArchetype.BOW))
        ItemArchetype.WEAPONS.filter { it != ItemArchetype.BOW }.forEach { archetype ->
            assertTrue(
