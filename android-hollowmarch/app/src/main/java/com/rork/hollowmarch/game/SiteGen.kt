...
object SiteGen {
    ...
    fun buildingInterior(
        ...
        map.walls[doorLY * w + doorLX] = 0
        map.portals += Portal(
            x = doorLX + 0.5f, y = doorLY + 0.5f,
            label = "the doorway", prompt = "Step out of ${building.name}",
    ...
    private fun looseEnemy(
        ...
        repeat(20) {
            ...
            map.entities += MapFactory.rollEnemy(rng, x, y, levelBase, roster, cultureId, geography)
            return
        }
    }
    ...
    private fun roomEnemy(
        ...
        map.entities += MapFactory.rollEnemy(rng, ex, ey, levelBase, roster, cultureId, geography)
    }
