...
data class Portal(
    ...
    /** A building's door: it bars the walk, and answers the USE hand from a pace or two. */
...
object MapFactory {
    ...
    fun wilds(
        ...
        repeat(5) {
            ...
            map.entities += rollEnemy(rng, ex + 0.5f, ey + 0.5f, 1 + day / 25, roster, cultureId, geography)
        }
