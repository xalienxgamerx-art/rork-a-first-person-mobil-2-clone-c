...
/**
 * The eight families of close combat the province knows. Every melee arm belongs
 * to exactly one; the bow belongs to none — a bow swung in desperation counts as
 * bare hands, and its true craft lives in Marksmanship.
 */
