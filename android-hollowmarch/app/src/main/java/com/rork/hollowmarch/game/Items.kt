...
enum class Material(
    ...
    BOG_IRON("bog iron", "Bog-Iron", 1.30f, 0.85f, 0.70f, 1.00f, 1.15f, 0.90f, 30),
    VERDIGRIS("verdigris bronze", "Verdigris", 1.00f, 1.05f, 1.00f, 1.10f, 0.90f, 1.00f, 25),
    COPPER("copper", "Copper", 1.00f, 1.05f, 0.50f, 0.95f, 0.90f, 0.90f, 28),
    IRON("iron", "Iron", 1.15f, 0.95f, 0.90f, 1.05f, 1.10f, 1.00f, 20),
    LEAD("lead", "Lead", 1.70f, 0.65f, 0.60f, 0.60f, 1.40f, 0.70f, 12),
    BRASS("temper brass", "Brass", 0.90f, 1.10f, 1.40f, 0.90f, 0.85f, 1.10f, 15),
    BONE("barrow bone", "Bone", 0.60f, 1.20f, 0.60f, 1.15f, 0.70f, 0.85f, 15),
    ASHWOOD("ashwood", "Ashwood", 0.70f, 1.10f, 0.50f, 0.70f, 1.10f, 0.90f, 10),
    STEEL("steel", "Steel", 0.95f, 1.05f, 1.80f, 1.25f, 1.00f, 1.15f, 8),
    SILVER("silver", "Silver", 0.90f, 1.05f, 2.40f, 1.05f, 0.80f, 1.10f, 5),
    GOLD("gold", "Gold", 1.35f, 0.85f, 4.00f, 0.55f, 0.75f, 0.60f, 2),
    SALT_GLASS("salt-glass", "Salt-Glass", 0.55f, 1.15f, 1.60f, 0.85f, 0.50f, 1.30f, 3),
    GRAVE_SLATE("grave-slate", "Grave-Slate", 1.60f, 0.70f, 0.55f, 0.75f, 1.35f, 0.70f, 2),
    STAR_IRON("star-iron", "Star-Iron", 0.75f, 1.15f, 3.50f, 1.35f, 0.90f, 1.25f, 2, arcane = true),
    SPIRIT_SILVER("spirit-silver", "Spirit-Silver", 0.60f, 1.20f, 4.00f, 1.15f, 0.60f, 1.35f, 2, arcane = true),
    EARTH_BONE("earth-bone", "Earth-Bone", 1.40f, 0.85f, 4.50f, 1.20f, 1.30f, 1.10f, 2, arcane = true);
...
enum class ItemArchetype(
    ...
    val stacks: Boolean get() = this == REMEDY || this == TORCH
...
data class Item(
    ...
    /** What it weighs, all of it together for stackables. */
    fun weight(): Float = (archetype.baseWeight * material.weightFactor() * count).let { (it * 100).roundToInt() / 100f }
    ...
    fun encode(): String =
        listOf(archetype.name, material.name, quality.name, "$cultureId", "$count", "$uid")
            .joinToString(FIELD)
